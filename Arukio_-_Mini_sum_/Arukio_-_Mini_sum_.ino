...
void loop () {
  ...
  Serial.println(valorDisD);*/
    ...
    if(mediaT >= 680 && mediaE >= 600  && mediaD >= 650){ // Avalia se ta no preto
      ...
      if(vetorDisF[0] <= 30 && vetorDisF[1] <= 30 && vetorDisF[2] <= 30){
        ...
        while(vetorDisF[0] > 30 || vetorDisF[1] > 30 || vetorDisF[2] > 30){
          ...
          if(mediaT < 680 || mediaE < 600 || mediaD < 650){
  ...
  valorDisF = 13*pow(leituraDisF * 0.0048828125 , -1);
    ...
    // Criar funções de reação: Um robô esta se aproximando, devemos aumentar a velocidade pra criar resistencia ao ser empurrado?
      ...
      if(mediaT < 680 && mediaE >= 600 && mediaD >= 650){ // Se ler o branco pelo sensor infra de tras
        frente();    
        Serial.println("fugiu da borda pelo de tras"); 
        delay(900);
       
      }
      else if(mediaE < 600 && mediaD >= 650 && mediaT >= 680){ // Se ler o branco pelo sensor infra da esquerda
        parar();
        direita();
      ...
      else if(mediaD < 650 && mediaE >= 600 && mediaT >= 680){ // Se ler o branco pelo sensor infra da direita
        parar();
        esquerda();
      ...
      else if(mediaD < 650 && mediaE < 600 && mediaT >= 680){
        parar();
        re();
        Serial.println("fugiu da borda pelos das laterais"); 
        delay(900); 
      }
      else if(mediaE < 600 && mediaT < 680 && mediaD >= 650){
        direita();
        delay(500);
        frente();
      }
      else if(mediaD < 650 && mediaT < 680 && mediaE >= 600){
        esquerda();
        delay(500);
        frente();
      }
      else if(mediaE < 600 && mediaD < 650 && mediaT < 680){
        re();
        delay(500);
      }      
    }
